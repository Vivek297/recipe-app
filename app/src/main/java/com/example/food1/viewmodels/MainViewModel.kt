...
import com.example.food1.data.Repository
...
class MainViewModel @Inject constructor(
    ...
    // ROOM DATABASE
    val readRecipes: LiveData<List<RecipesEntity>> = repository.local.readRecipes().asLiveData() // converting flow into live data
